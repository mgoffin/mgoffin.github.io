...
With my late night tonight, I setup this domain, purchased a VPS from <a href="https://www.linode.com/" onclick="_gaq.push(['_trackEvent', 'outbound-article', 'https://www.linode.com/', 'Linode']);" >Linode</a>, and built the site. I think the biggest pain was configuring <a href="https://nginx.org/" onclick="_gaq.push(['_trackEvent', 'outbound-article', 'https://nginx.org/', 'nginx']);" >nginx</a> with php-fastcgi support. On that note, I find it horribly frustrating that nginx, one of the most lightweight and speedy web servers, causes so much <a href="https://library.linode.com/web-servers/nginx/php-fastcgi-ubuntu9.10-karmic" onclick="_gaq.push(['_trackEvent', 'outbound-article', 'https://library.linode.com/web-servers/nginx/php-fastcgi-ubuntu9.10-karmic', 'pain']);" >pain</a> to get PHP working. I hardly think that installing spawn-fcgi, and writing a bunch of custom executables and init scripts is an adequate way to go about doing it. But hey, at least it works. 
